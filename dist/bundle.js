...
function slider({
  ...
  let i = 1;
  totSlides.textContent = slidesTotal.toLocaleString(undefined, {
    minimumIntegerDigits: 2
  });
  curSlide.textContent = i.toLocaleString(undefined, {
    minimumIntegerDigits: 2
  });
  ...
  dotsArr.forEach(dot => {
    dot.addEventListener("click", e => {
      ...
      curSlide.textContent = parseInt(i).toLocaleString(undefined, {
        minimumIntegerDigits: 2
      });
...
window.addEventListener("DOMContentLoaded", () => {
  ...
  function setClock(selector, endtime) {
    ...
    function updateClock() {
      ...
      days.innerHTML = t.days.toLocaleString(undefined, {
        minimumIntegerDigits: 2
      });
      hours.innerHTML = t.hours.toLocaleString(undefined, {
        minimumIntegerDigits: 2
      });
      minutes.innerHTML = t.minutes.toLocaleString(undefined, {
        minimumIntegerDigits: 2
      });
      seconds.innerHTML = t.seconds.toLocaleString(undefined, {
        minimumIntegerDigits: 2
      });
      if (t.total <= 0) {
